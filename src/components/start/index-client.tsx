...
export default function StartComponentClient({ fotoPerfil }: { fotoPerfil: string }) {
    ...
    return (
        <div className="w-full h-[80vh] flex items-center justify-between max-lg:flex-col-reverse">
            <section className="flex flex-col gap-5 max-lg:items-center">
                <div
                    className="flex flex-col max-lg:text-center opacity-0 cursor-default"
                    ref={textRef}
                >
            ...
            <div
                className="perfilrt max-md:my-auto"
                ref={imgRef}
            >
                <Image
                    src={fotoPerfil}
